<?php require_once 'inc/header.php';?>
		...
		<div class="wrapper bg-dark-white">
			...
			<?php
				...
				$catresult = $db->prepare("SELECT id,katbaslik,katsef,katdurum,katresim FROM urun_katagoriler WHERE katsef=:se AND katdurum=:d");
				$catresult->execute([':se'=>$cat,':d'=>1]);
			...
			<!-- HEADING-BANNER START    resim ekleme banner -->
								...
								<div class="shop-pagination text-center">
									<div class="pagination">
										...
										if($total>$lim){
											...
											pagination($s,cail($total/$lim),'catagory.php?catsef='.$cat.'$s');
										}
